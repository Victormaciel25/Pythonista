# //tag[@atributo='valor']
# exemplo: //button[@aria-label='Toggle navigation']
...
th = driver.find_element(By.XPATH, "//thead//tr//th[3]")
fieldset = driver.find_elements(By.XPATH, '//div/fieldset')

if th:
    print('Th encontrado')
if fieldset:
    print('fieldset encontrado')
