...
print(driver.find_element(By.XPATH, '//a[@class="navbar-brand"]').text) # Extrai o texto do elemento indicado
print(driver.find_element(    By.XPATH, '//a[@class="navbar-brand"]').get_attribute("style")) # Obtem um atributo escolhido através do "get_attribute"
